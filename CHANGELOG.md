...
- 2026-06-21 · **(b) + retoques**: opinar con IMAGEN desde el móvil (tabla `public.feedback` + Storage; llega solo a MADRE, sin pegar). Flechas de ayuda ahora pegadas a su sitio y crecen al hover (antes flotaban). · revertir: `git revert <este commit>`
